...
if [[ "${_archi[*]}" = "x86_64" ]]; then
    ...
    _else_pkg_dir="$filesdir/aur-packages/packages"
    _else_pkg_name="$filesdir/aur-packages/"
	git_pkg_mngr="https://github.com/maximalisimus/aur-package-manager.git"
	_pkg_mngr_dir="$filesdir/aur-package-manager/package-manager"
	_pkg_mngr_name="$filesdir/aur-package-manager/"
	git_eml_pkg="https://github.com/maximalisimus/aur-emulators.git"
	_eml_pkg_dir="$filesdir/aur-emulators/emulators"
    _eml_pkg_name="$filesdir/aur-emulators/"
	git_nvidia390_pkg="https://github.com/maximalisimus/aur-nvidia-390xx.git"
	_nvidia390_dir="$filesdir/aur-nvidia-390xx/nvidia_390xx"
	_nvidia390_name="$filesdir/aur-nvidia-390xx/"
	git_nvidia340_pkg="https://github.com/maximalisimus/aur-nvidia-340xx.git"
	_nvidia340_dir="$filesdir/aur-nvidia-340xx/nvidia_340xx"
	_nvidia340_name="$filesdir/aur-nvidia-340xx/"
else
    ...
    _eml_folder="$filesdir/packages_i686/emulators"
    _aur_pkg_folder="$filesdir/packages_i686"
    _pkg_manager_folder="$filesdir/packages_i686/package-manager"
    git_else_pkg="https://github.com/maximalisimus/aur-packages-i686.git"
    _else_pkg_dir="$filesdir/aur-packages-i686/packages_i686"
    _else_pkg_name="$filesdir/aur-packages-i686/"
	git_pkg_mngr="https://github.com/maximalisimus/aur-package-manager-i686.git"
	_pkg_mngr_dir="$filesdir/aur-package-manager-i686/package-manager"
	_pkg_mngr_name="$filesdir/aur-package-manager-i686/"
	git_eml_pkg="https://github.com/maximalisimus/aur-emulators-i686.git"
	_eml_pkg_dir="$filesdir/aur-emulators-i686/emulators"
    _eml_pkg_name="$filesdir/aur-emulators-i686/"
	git_nvidia340_pkg="https://github.com/maximalisimus/aur-nvidia-390xx-i686.git"
	_nvidia390_dir="$filesdir/aur-nvidia-390xx-i686/nvidia_390xx"
	_nvidia390_name="$filesdir/aur-nvidia-390xx-i686/"
	git_nvidia390_pkg="https://github.com/maximalisimus/aur-nvidia-340xx-i686.git"
	_nvidia340_dir="$filesdir/aur-nvidia-340xx-i686/nvidia_340xx"
	_nvidia340_name="$filesdir/aur-nvidia-340xx-i686/"
fi
