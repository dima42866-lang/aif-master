...
install_de_wm() {
   ...
   if [[ $_d_menu_once == "0" ]]; then
		...
		for i in ${_list_d_menu[*]}; do
			case $i in
				"cinnamon") _dm_desktop_menu="${_dm_desktop_menu} Cinnamon" # cinnamon
					;;
				"enlightenment") _dm_desktop_menu="${_dm_desktop_menu} Enlightenment" # enlightenment
					;;
				"gnome-shell") _dm_desktop_menu="${_dm_desktop_menu} Gnome-Shell_minimal" # gnome-shell
					;;
				"gnome") _dm_desktop_menu="${_dm_desktop_menu} Gnome" # gnome
					;;
				"gnome-extra") _dm_desktop_menu="${_dm_desktop_menu} Gnome_Gnome-Extras" # gnome-extra
					;;
				"plasma-desktop") _dm_desktop_menu="${_dm_desktop_menu} KDE5-Base_minimal" # plasma-desktop
					;;
				"plasma") _dm_desktop_menu="${_dm_desktop_menu} KDE5" # plasma
					;;
				"lxde") _dm_desktop_menu="${_dm_desktop_menu} LXDE" # lxde
					;;
				"lxqt") _dm_desktop_menu="${_dm_desktop_menu} LXQT" # lxqt
					;;
				"mate") _dm_desktop_menu="${_dm_desktop_menu} MATE" # mate
					;;
				"mate-extra") _dm_desktop_menu="${_dm_desktop_menu} MATE_MATE-Extras" # mate-extra
					;;
				"xfce4") _dm_desktop_menu="${_dm_desktop_menu} Xfce" # xfce4
					;;
				"xfce4-goodies") _dm_desktop_menu="${_dm_desktop_menu} Xfce_Xfce-Extras" # xfce4-goodies
					;;
				"awesome") _dm_desktop_menu="${_dm_desktop_menu} Awesome-WM" # awesome
					;;
				"fluxbox") _dm_desktop_menu="${_dm_desktop_menu} Fluxbox-WM" # fluxbox
					;;
				"i3-wm") _dm_desktop_menu="${_dm_desktop_menu} i3-WM" # i3-wm
					;;
				"icewm") _dm_desktop_menu="${_dm_desktop_menu} Ice-WM" # icewm
					;;
				"openbox") _dm_desktop_menu="${_dm_desktop_menu} Openbox-WM" # openbox
					;;
				"pekwm") _dm_desktop_menu="${_dm_desktop_menu} Pek-WM" # pekwm
					;;
				"windowmaker") _dm_desktop_menu="${_dm_desktop_menu} WindowMaker-WM" # windowmaker
					;;
			esac
		done
		_list_dm_menu=""
